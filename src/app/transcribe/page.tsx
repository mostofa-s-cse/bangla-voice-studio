...
export default function TranscribePage() {
  ...
  const handleTranscribe = async () => {
    ...
    try {
      ...
      setErrorMessage(err instanceof Error ? err.message : "অডিও থেকে টেক্সট তৈরি করতে ব্যর্থ হয়েছে।");
    } finally {
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      setErrorMessage(err instanceof Error ? err.message : "অনুবাদ করতে ব্যর্থ হয়েছে।");
    } finally {
